...
app.post('/api/gerar-pdf', (req, res) => {
  try {
    ...
    res.setHeader('Content-Disposition', `attachment; filename=resumo_servicos_${cadastro.nomeCliente}.pdf`);
    ...
    doc.text(`Tempo por página (scanner): ${servicos.digitalizacao.tempoScanner} min`);
    ...
    doc.fontSize(14).text(`Total com margem de 10%: ${resultados.totalComMargem} horas`, { bold: true });
