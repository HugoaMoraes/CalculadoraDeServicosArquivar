...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <a
        href="https://github.com/HugoaMoraes/CalculadoraDeServicosArquivar"
      ...
      <div className="container mx-auto px-4 py-8">
        <h1 className="titulo-projeto text-4xl font-bold text-center mb-8">
